...
public class WeatherService extends IntentService {
    ...
    //pull parameter out of Intent object
    @Override
     ...
     * parameters.
     */
    //where actual work happened to fetch data
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) //got 200 OK back
            {
                //Java IO grab that buffer of data and turns them to bianry array
                ...
                //Use JSON object to pass with content
                ...
                //put that information to Intent and
