...
//////                .build();
        ...
        Places.initialize(getApplicationContext(), "AIzaSyBDWMqUeh8TO4DE43rWN2oW45rRu3PrsH0");
    ...
    public void onResume(){
        ...
        //Activate that broadcast receiver
    ...
    //Broadcast receiver to listen to the WeatherService
    private BroadcastReceiver weatherReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "onReceive: " + intent);
            //get information from the intent
            //pulling data out of intent object which is from the
    ...
    //after hit <Calculate> button -try to find weather information for those two points
    //when calculate button is pressed, then you wanna fetch weather data
    ...
    //call updateScreen when user clicks on Calculate
...
//            HistoryContent.addItem(item);
            ...
            WeatherService.startGetWeather(this, Double.toString(lat1), Double.toString(lng1), "p1"); //pass key value back to Broadcast receiver
